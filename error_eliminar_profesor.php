...
if (!isset($_SESSION['error_eliminar_profesor'])) {
    // Si no hay mensaje de error, redirigir al listado de profesores
    header("Location: ListadoProfesores.php");
    exit();
}

// Obtener los datos del error
$error_data = $_SESSION['error_eliminar_profesor'];
...
unset($_SESSION['error_eliminar_profesor']);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Error al Eliminar Profesor</title>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="error-container">
                <h1 class="error-title">No se puede eliminar el profesor</h1>
                ...
                <div class="error-message">
                    ...
                    <?php if (!empty($asignaturas)): ?>
                        <div class="asignaturas-list">
                            ...
                            <p>Para eliminar este profesor, primero debe reasignar o eliminar estas asignaturas.</p>
                        </div>
                    <?php endif; ?>
                </div>
                
                <div class="buttons">
                    <a href="ListadoProfesores.php" class="btn">Volver al listado</a>
                    <?php if (!empty($asignaturas)): ?>
