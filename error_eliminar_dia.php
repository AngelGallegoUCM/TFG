...
if (!isset($_SESSION['error_eliminar_dia'])) {
    // Si no hay mensaje de error, redirigir al listado de días no lectivos
    header("Location: ListadoNoLectivo.php");
    exit();
}

// Obtener los datos del error
$error_data = $_SESSION['error_eliminar_dia'];
...
unset($_SESSION['error_eliminar_dia']);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Error al Eliminar Día No Lectivo</title>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="error-container">
                <h1 class="error-title">No se puede eliminar el día no lectivo</h1>
                ...
                <div class="buttons">
                    <a href="ListadoNoLectivo.php" class="btn">Volver al listado</a>
